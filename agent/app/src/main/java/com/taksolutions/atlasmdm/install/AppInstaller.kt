...
package com.taksolutions.atlasmdm.install
...
class AppInstaller(private val context: Context) {
    ...
    companion object {
        ...
        private const val ACTION_INSTALL_RESULT = "com.taksolutions.atlasmdm.INSTALL_RESULT"
        private const val ACTION_UNINSTALL_RESULT = "com.taksolutions.atlasmdm.UNINSTALL_RESULT"
